...
| C06 | MPS validation behavior and computational cost vary with bond dimension. | Planned `results/pilots/2026-07-28/dimension_summary.csv` | Pending. Do not state a direction or selected dimension until the guarded pilot completes. |
...
|---|---|---|---|
| T01 | Data splits, state construction, costs, PPO budget, seeds, and encoder controls | `results/run_manifest.json`, `docs/EXPERIMENT_PROTOCOL.md`, `docs/DECISIONS.md` | Partially ready; final dimension pending |
| T02 | Bond-dimension validation, parameter, runtime, and descriptive trading sensitivity | Planned dimension summary and paired CSV files | Pending |
...
| ID | Planned content | Source | Status |
|---|---|---|---|
| F01 | MPS validation error and runtime by bond dimension | Planned dimension summary CSV | Pending |
